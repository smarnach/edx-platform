        ...
        describe( 'edx.verify_student.WebcamPhotoView', function() {
            ...
            */
            ...
            var expectButtonShown = function( obj ) {
                ...
                expect( captureButton.is( ':visible' ) ).toBe( obj.snapshot );
                expect( resetButton.is( ':visible' ) ).toBe( obj.reset );
            };
            ...
            beforeEach(function() {
                window.analytics = jasmine.createSpyObj('analytics', ['track', 'page']);
