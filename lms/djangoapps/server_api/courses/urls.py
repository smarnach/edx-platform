...
course_specific_patterns = patterns(
    ...
    url(r'^assignments/$', courses_views.CourseAssignments.as_view(), name='assignments'),
    url(r'^grading_policy/$', courses_views.CourseGradingPolicy.as_view(), name='grading_policy'),
