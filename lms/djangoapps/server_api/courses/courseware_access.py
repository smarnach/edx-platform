...
def _filter_problems(node):
    ...
    for child in node.get_children():
        problems += _filter_problems(child)
...
def get_course_assignments(course_id):
    ...
    assignments = get_modulestore().get_items(course_key, settings={'graded': True})

    for assignment in assignments:
        problems = _filter_problems(assignment)
