...
class CohortHandlerTestCase(CohortViewsTestCase):
    ...
    def test_update_cohort_name(self):
        """
        Test that it is possible to update the name of an existing cohort.
        """
        self._create_cohorts()
        updated_name = "change name only"
        self.assertNotEqual(updated_name, self.cohort1.name)
        ...
        # self.assertEqual((0, 0), get_group_info_for_cohort(self.cohort1))
